"""
===> G.C.U.H v1.10  8th May 2016
Classified Gender form handwriting using Random Forest.
...
X_train = X[3::4]#X-train contains 4th row traing features
...
#
#
obj = RandomForestRegressor(n_estimators=100, criterion='mse'
                                  , max_features=80, max_depth=5)
